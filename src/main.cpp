...
unsigned int nStakeMinAge = 60 * 60 * 24 * 10;
unsigned int nStakeMaxAge = 60 * 60 * 24 * 180;
unsigned int nStakeTargetSpacing = 60;			

int64 nChainStartTime = 1517666667;
...
static int FINAL_POW_HEIGHT = 2108986;
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, const CBlockIndex* pindex)
{
     ...
     if (nHeight ==1)
       nSubsidy = CIRCULATION_MONEY; //Premin: 1.1B
     else
       nSubsidy = 0 * COIN;
...
int64 GetProofOfStakeReward(int64 nCoinAge, unsigned int nBits, unsigned int nTime, int nHeight)
{
    ...
    if (nHeight <= 259000)
		nSubsidy = (nCoinAge * 0.6 * COIN )/ 365;
    else if(nHeight > 259000 && nHeight<=518000)
		nSubsidy = (nCoinAge * 0.4 * COIN )/ 365;
	else if(nHeight>518000&&nHeight<=777000)
		nSubsidy = (nCoinAge * 0.3 * COIN )/ 365;
	else
		nSubsidy = (nCoinAge * 0.2 * COIN )/ 365;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "VitalCoin 2.3, 2018.wish a great coin!";
        CTransaction txNew;
      ...
      if (true  && (block.GetHash() != hashGenesisBlock))
        ...
        assert(block.hashMerkleRoot == uint256("0xba0387525a2d6c304760dad9405a28668dd5ee8b8ef747f12afbcfd118471468"));
...
unsigned char pchMessageStart[4] = { 0xde, 0xf7, 0xcd, 0xd4 };
